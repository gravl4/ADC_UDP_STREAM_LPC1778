...
//	{0x0, 31, (IOCON_FUNC1 | IOCON_MODE_INACT)},
	...
	{1, 18, (IOCON_FUNC0 | IOCON_MODE_INACT)}, // E_RST_PHY
...
//	{2, 0, (IOCON_FUNC2 | IOCON_MODE_INACT)}, 	// GSM_TX Out
//	{2, 1, (IOCON_FUNC2 | IOCON_MODE_INACT)}, 	// GSM_RX In
//	{2, 2, (IOCON_FUNC0 | IOCON_MODE_INACT)}, 	// GSM_CTS In
//	{2, 3, (IOCON_FUNC0 | IOCON_MODE_INACT)}, 	// GSM_STATUS In
//	{2, 4, (IOCON_FUNC0 | IOCON_MODE_INACT)}, 	// GSM_POWER_ON Out
//	{2, 5, (IOCON_FUNC0 | IOCON_MODE_INACT)}, 	// GSM_DTR Out
//	{2, 6, (IOCON_FUNC0 | IOCON_MODE_INACT)}, 	// GSM_RESET Out
//	{2, 7, (IOCON_FUNC0 | IOCON_MODE_INACT)}, 	// GSM_RTS Out
///	{2, 8, (IOCON_FUNC0 | IOCON_MODE_INACT)}, 	// GSM_LDO_CNTRL Out

//	{2, 13, (IOCON_FUNC0 | IOCON_MODE_INACT)}, 	// Default

	{4, 30, (IOCON_FUNC0 | IOCON_MODE_INACT)}, 	// CPU_LED2
	{4, 31, (IOCON_FUNC0 | IOCON_MODE_INACT)}, 	// CPU_LED1

//	{2, 11, (IOCON_FUNC0 | IOCON_MODE_INACT)}, //EN_OUT12
//	{2, 12, (IOCON_FUNC0 | IOCON_MODE_INACT)}, //EN_OUT5

//	{0x0, 23, (IOCON_FUNC1 | IOCON_ADMODE_EN)}, //ch0 ADC ACC_POW
//	{0x0, 24, (IOCON_FUNC1 | IOCON_ADMODE_EN)}, //ch1 ADC ION_POW
//	{0x0, 25, (IOCON_FUNC1 | IOCON_ADMODE_EN)}, //ch2 ADC ADC_I
//	{0x0, 26, (IOCON_FUNC1 | IOCON_ADMODE_EN)}, //ch3 ADC ADC_U

//	{0, 22, (IOCON_FUNC0 | IOCON_MODE_INACT)}, //EN_24V_CSEN
