...
/*const static char http_index_html[] =
	...
	"<p>This is a small test page, served by httpd of lwip. my page</h1>"
	"my page"
	"</p></body></html>";*/
/*const static char http_index_html[] =
	"<html><head><title>Congrats!</title></head>"
...
const static char http_index_html[] =
		"<html><head><title>Congrats!</title></head>"
				"<form id=\"form\" action=\"upload\" method=\"post\" enctype=\"multipart/form-data\" Content-Length: 256>"
				"<input id=\"file\" type=\"file\" name=\"binary\" accept=\".bin,.bin\">"
